...
Extra!!
If you want to test your object_detction_tf_api model using webcam download the [object_detection_tutorial_tensorflow.py]() put it into models/research/objection_detection/ and run it by `python object_detection_tutorial_tensorflow.py`. 
